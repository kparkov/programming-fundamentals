...
namespace Gladiator
{
    public class Gladiator
    {
        ...
        public void Attack(Gladiator enemy)
        {
            ...
            var enemysDefenseRoll = enemy.CombatRoll(enemy.DefenseScore);

            if (attackRoll > enemysDefenseRoll)
            {
                var damage = attackRoll - enemysDefenseRoll;
                enemy.HitPoints -= damage;

                Console.WriteLine(
                    $"I rolled {attackRoll} against enemys {enemysDefenseRoll}, " +
            ...
            {
                Console.WriteLine(
                    $"I missed with {attackRoll} against enemys {enemysDefenseRoll}."
                );
            }
        }
