...
namespace Exercises
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Nu kører tælleren!");
            }
            counter = counter + 1;



            // It should run as many times as the "repeat" variable states. Write the same line of text to the console each time.
