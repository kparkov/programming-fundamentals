...
namespace BooleanExpressions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Må prøve Mariehønen: " + canTryMariehønen);
            ...
            Console.WriteLine("Må prøve Veteranbilerne: " + canTryVeteranbilerne);
            ...
            Console.WriteLine("Må prøve Ballongyngerne: " + canTryBallongyngerne);
            ...
            Console.WriteLine("Må prøve Rutsjebanen: " + canTryRutsjebanen);
            ...
            Console.WriteLine("Må prøve Dæmonen: " + canTryDæmonen);
            ...
            Console.WriteLine("Må prøve Kaoshuset: " + canTryKaoshuset);
