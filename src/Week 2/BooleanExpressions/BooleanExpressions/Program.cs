...
namespace BooleanExpressions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bool canTryRutschebanen = customerHeight <= 210 && customerWeight <= 190;
            ...
            bool canTryKaoshuset = customerAge != 100 && (customerWeight >= 40 && customerWeight <= 60 || customerAge >= 90 && customerAge <= 110);

            Console.WriteLine(canTryMariehønen);
            Console.WriteLine(canTryVeteranbilerne);
            Console.WriteLine(canTryBallongyngerne);
            Console.WriteLine(canTryRutschebanen);
